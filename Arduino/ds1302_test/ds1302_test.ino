/*
* DS1302RTC Arduino Tutorial
* by Dicson Pan @PastorEdu
* 如果"#define SET_DATE_TIME_JUST_ONCE"这行不注释的话，便是设置一次时间；如果这行注释掉的话，便是显示现在这个模块的时间
*/

// Set your own pins with these defines !
#define DS1302_SCLK_PIN   8    // Arduino pin for the Serial Clock or named CLK
#define DS1302_IO_PIN     9    // Arduino pin for the Data I/O or named DAT
#define DS1302_CE_PIN     10    // Arduino pin for the Chip Enable or named RST
